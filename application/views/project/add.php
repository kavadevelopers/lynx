...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="<?= base_url('project/save') ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="project_name" placeholder="Project Code/Name" value="<?php echo set_value('project_name'); ?>" autocomplete="off" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2" name="client">
                                                ...
                                                <?php foreach ($this->general_model->get_clients() as $key => $value) { ?>
                                                    <option value="<?= $value['id'] ?>" <?= set_value('client') == $value['id']?'selected':'' ?>><?= $value['cname'] ?> - <?= $value['bname'] ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Remarks</label>
                                            <textarea class="form-control form-control-sm" type="text" name="remarks" placeholder="Remarks" value="" autocomplete="off" ><?php echo set_value('remarks'); ?></textarea>
