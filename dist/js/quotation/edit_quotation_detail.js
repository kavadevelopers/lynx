var box = document.getElementById("box_length_edit").value;
$(function(){
...
function remove_row_func(id)
{
	...
	if($('#table'+nbox+' tbody tr').length != 1){
		...
		total(id);
		$('#T_lEngth'+nbox).val(parseFloat($('#T_lEngth'+nbox).val()) - 1);
		return false;
	}
	return false;
}
